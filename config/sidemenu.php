                        ...
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a><i class="fa fa-edit"></i> Produto <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="celulares.php">Celular</a></li>
                                    </ul>
                                </li>
                                ...
                                <li><a><i class="fa fa-table"></i> Funcionario <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="tables.html">Tables</a></li>
                                        <li><a href="tables_dynamic.html">Table Dynamic</a></li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-bar-chart-o"></i> Venda <span
                                        class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
